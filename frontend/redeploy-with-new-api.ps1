...
"VITE_API_URL=https://final-ecri.onrender.com/api/v1" | Out-File -FilePath .env.production -Encoding UTF8
...
Write-Host "Your frontend will connect to the correct backend at final-ecri.onrender.com" -ForegroundColor Cyan 